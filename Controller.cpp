...
// Algorithme :
{
	...
	else if ( (mots.size()==2) && ( (mots[0]=="SAVE") || (mots[0]=="LOAD") ) )
	{
		if ( mots[0] == "LOAD" )
		{
			Charger(mots[1]);
	...
	else if ( (mots[0]=="C") && (mots.size()==5) && (atoi(mots[2].c_str())) && (atoi(mots[3].c_str())) && (atoi(mots[4].c_str())) && (!this->ObjetExistant(mots[1])) )
	{
